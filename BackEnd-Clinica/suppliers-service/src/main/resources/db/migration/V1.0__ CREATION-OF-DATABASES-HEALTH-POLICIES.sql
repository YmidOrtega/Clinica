...
CREATE TABLE health_providers (
    ...
    contract_status VARCHAR(20) DEFAULT 'ACTIVE' NOT NULL,
    ...
    INDEX idx_health_providers_contract_status (contract_status),
    ...
    CONSTRAINT chk_health_providers_contract_status_values
        CHECK (contract_status IN ('ACTIVE', 'INACTIVE', 'PENDING', 'SUSPENDED')),
