package com.ClinicaDeYmid.clinical_history_service.module.service;

import com.ClinicaDeYmid.clinical_history_service.infra.exception.BusinessException;
import com.ClinicaDeYmid.clinical_history_service.infra.exception.ResourceNotFoundException;
import com.ClinicaDeYmid.clinical_history_service.infra.security.UserContextHolder;
import com.ClinicaDeYmid.clinical_history_service.module.dto.chronic.ChronicDiseaseRequestDTO;
import com.ClinicaDeYmid.clinical_history_service.module.dto.chronic.ChronicDiseaseResponseDTO;
import com.ClinicaDeYmid.clinical_history_service.module.dto.chronic.ChronicDiseaseSummaryDTO;
import com.ClinicaDeYmid.clinical_history_service.module.dto.chronic.ChronicDiseaseUpdateDTO;
import com.ClinicaDeYmid.clinical_history_service.module.entity.ChronicDisease;
import com.ClinicaDeYmid.clinical_history_service.module.entity.Patient;
import com.ClinicaDeYmid.clinical_history_service.module.enums.DiseaseSeverity;
import com.ClinicaDeYmid.clinical_history_service.module.mapper.ChronicDiseaseMapper;
import com.ClinicaDeYmid.clinical_history_service.module.repository.ChronicDiseaseRepository;
import com.ClinicaDeYmid.clinical_history_service.module.repository.PatientRepository;
