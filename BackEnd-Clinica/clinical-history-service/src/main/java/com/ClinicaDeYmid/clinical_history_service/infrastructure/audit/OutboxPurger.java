...
class OutboxPurger {
    ...
    private static final String DELETE_EXPIRED = "DELETE FROM " + JdbcAccessAuditOutbox.TABLE
    ...
    @Scheduled(initialDelayString = "PT1M", fixedDelayString = "${clinica.clinical.outbox.purge-interval:PT1H}")
    int purgeExpired() {
