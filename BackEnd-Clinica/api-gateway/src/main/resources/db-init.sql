-- Script de inicialización de base de datos para API Gateway
-- Crear base de datos para logging
CREATE DATABASE IF NOT EXISTS clinica_gateway;

\c clinica_gateway;

-- La tabla request_logs será creada automáticamente por JPA
-- Este script es opcional y solo para referencia
